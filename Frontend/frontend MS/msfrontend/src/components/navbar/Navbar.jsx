...
<nav  role="navigation" aria-label="Main" tabIndex="0" className="hidden relative z-10 w-full lg:flex justify-between items-center p-8" style={{backgroundColor:'#f2faff'}}>
    <div className="w-1/6 flex items-center ">
        ...
        <div className="titlename" style={{fontSize:'30px',fontWeight:500,letterSpacing:'2px',color:'#012970',fontFamily:'Fantasy', whiteSpace: 'nowrap', }}>
        &nbsp; Fusion Track
        </div>
    </div>
    <div className="w-5/6">
        <div className="flex items-center justify-end">  
            <ul className="text-gray-800 lg:space-x-8 flex items-center leading-none">
                <li>
                <Link  className="focus:text-indigo-500 text-lg" to="/" style={{ textDecoration: 'underline', textUnderlineOffset: '6px' }}
                > Home </Link>


                </li>
                <li className="ml-4 hover:text-indigo-500 ">
                    <a className="focus:text-indigo-500 text-lg" href="http://localhost:8501/" style={{textDecoration : 'underline', textUnderlineOffset:'6px'}}>Surveillance Area</a>
                </li>
                <li className="ml-4 hover:text-indigo-500 focus:text-indigo-500">
                <Link className="focus:text-indigo-500 text-lg" to="/Formmissing" style={{ textDecoration: 'underline', textUnderlineOffset: '6px' }}>Report case</Link>

                </li>
                <li className="ml-4 hover:text-indigo-500 focus:text-indigo-500">
                <Link className="focus:text-indigo-500 text-lg" to="/Missingpeople" style={{ textDecoration: 'underline', textUnderlineOffset: '6px' }}>Missing List</Link>

                </li>
                <li className="ml-4 hover:text-indigo-500 focus:text-indigo-500">
                <Link className="focus:text-indigo-500 text-lg" to="/locations" style={{ textDecoration: 'underline', textUnderlineOffset: '6px' }}>Tracked locations</Link>
